        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="blog-item padd-15">
              <div className="blog-item-inner shadow-dark">
                <div className="blog-img">
                  <Image src="./imgs/blog/1.jpg" alt="Responsive Web Design" width={300} height={200}/>
            ...
            <div className="blog-item padd-15">
              <div className="blog-item-inner shadow-dark">
                <div className="blog-img">
                  <Image src="./imgs/blog/2.jpg" alt="Creative Slideshow" width={300} height={200} />
                  <div className="blog-date">June 4, 2020</div>
                </div>
                <div className="blog-info">
                  <h4 className="blog-title">
            ...
            <div className="blog-item padd-15">
              <div className="blog-item-inner shadow-dark">
                <div className="blog-img">
                  <Image src="./imgs/blog/3.jpg" alt="Image Gallery Lightbox" width={300} height={200} />
                  <div className="blog-date">June 4, 2020</div>
                </div>
                <div className="blog-info">
                  <h4 className="blog-title">
